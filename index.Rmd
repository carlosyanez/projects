---
title: ".large[Carlos Yáñez Santibáñez]"
...
meta() %>%
  ...
  meta_social(
    ...
    image = "https://carlosyanez.github.io/projects/img/portfolio_card.jpg",
...
# Nut-free Foods Search
.left-text[
.just-text[
Stastic dashboard to present and search nut-free foods in selected countries, allowing to filter by other allergens.
...
* [Demo](https://carlosyanez.github.io/nutfree/html/index.html#display=nut_free_foods&nrow=1&ncol=1&arr=row&pg=1&labels=&sort=&filter=&sidebar=&fv=)


**Technology/Tools** : R, trelliscopejs
